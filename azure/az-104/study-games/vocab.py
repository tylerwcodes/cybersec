"""Vocab Arcade: every AZ-104 term drilled with mixed question styles.

Pulls the full term bank from the 15 topic modules and pairs it with a
...
def arcade(mods, progress):
    ...
    while True:
        ...
        print(wrap(f"{len(bank)} terms from all 15 topics + {len(PAIRS)} "
